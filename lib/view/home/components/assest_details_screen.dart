...
class _AssetDetailsScreenState extends State<AssetDetailsScreen>
  ...
  final ClientMgrHomeController controller =
      Get.find<ClientMgrHomeController>();
  late Future<AssetImageModel> getImgFuture =
      controller.fetchImage(recordNo: widget.recordNo ?? '');
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('Error: ${snapshot.error}'));
              ...
              snapshot.data!.apiDataArray!.isEmpty) {
            return Center(
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  ...
                  MaterialButton(
                    onPressed: () {
                      showUploadAttachmentDialog(context, controller);
                    },
            ...
            // Populate the image list from API if not already populated
                ...
                Obx(
                  () => ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Slidable(
                        key: Key(
                            controller.imageList[index].fILENAME ?? 'No name'),
                          ...
                          children: [
                            SlidableAction(
                              onPressed: (context) async {
                                await controller.imageDeleteApi(
                                    controller.imageList[index].aUDITID!,
                                    widget.recordNo!,
                                    context,
                                    index);
                              },
                        ...
                        child: ListTile(
                          onTap: () {
                            controller.isImageOrPdf(
                                    controller.imageList[index].cONTENT!)
                                ? controller.showImages(
                                    context,
                                    controller.imageList[index].cONTENT!,
                                    controller.imageList[index].fILENAME ??
                                        'No name',
                                  )
                                : controller.showPDF(
                                    context,
                          ...
                          title: Text(
                            "File Name : ${controller.imageList[index].fILENAME}",
                            style: AppStyles.black_14_400,
                          ),
                          subtitle: Text(
                            "Create Date : ${controller.imageList[index].cREATEDATE!.toString()}",
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                        color: AppColors.blueShadeGradiant, width: 2),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () async {
                        await controller.pickPdfUnder4MB(
                            context, widget.recordNo!);
                      },
